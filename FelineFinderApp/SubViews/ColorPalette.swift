...
enum ColorPalette {
    ...
    static let pink = Color(uiColor: UIColor(red: 251/255, green: 196/255, blue: 171/255, alpha: 1))
    static let offWhite = Color(uiColor: UIColor(red: 250/255, green: 249/255, blue: 246/255, alpha: 1))
}
